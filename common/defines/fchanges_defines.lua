...
NDefines.NAir.COMBAT_MAX_WINGS_AT_ONCE = 500 						-- Max amount of air wings in one combat simulation. The higher value, the quicker countries may loose their wings. It's a gameplay balance value.

NDefines.NMilitary.UNIT_DIGIN_CAP = 8							-- how "deep" you can dig you can dig in until hitting max bonus. Every point counts as 2% entrenchment Vanilla value 5
