...
NDefines.NMilitary.ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0.15			 -- XP gain per unit in combat (Vanilla = 0.1)
NDefines.NMilitary.UNIT_LEADER_ASSIGN_TRAIT_COST = 10.0					-- cost to assign a new trait to a unit leader (Vanilla 15)
NDefines.NMilitary.LEADER_EXPERIENCE_SCALE = 1.25						-- (Vanilla 1.0)
